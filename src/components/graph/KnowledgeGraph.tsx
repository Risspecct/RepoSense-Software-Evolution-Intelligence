...
export const KnowledgeGraph = ({ nodes, edges, setNodes, setEdges }: KnowledgeGraphProps) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-20 right-4 w-80 max-h-[78vh] overflow-y-auto bg-white/95 border border-[#E4E1D8] rounded-2xl shadow-xl p-4 text-[#171A21] z-40 space-y-3 backdrop-blur-md">
        ...
        {activeTab === 'info' && (
          <div className="space-y-3 text-xs">
            ...
            {selectedNode && (
              <div className="rounded-xl border border-[#E4E1D8] bg-[#F8F7F4] p-3 space-y-2">
                <div className="flex items-center justify-between text-[10px] font-bold font-mono-code uppercase text-[#243B6B]">
                ...
                <div className="space-y-2">
                  <div>
                    <h3 className="text-sm font-bold font-mono-code text-[#171A21]">{selectedNode.data.label}</h3>
                    <p className="text-[11px] text-[#5B5F6B] mt-0.5">{selectedNode.data.subtext || selectedNode.id}</p>
                  </div>

                  {selectedNode.data.author && (
                    <div className="text-[11px] text-[#243B6B] font-mono-code">
                  ...
                  {selectedNode.data.category === 'class' && (
                    <div className="space-y-2">
                      <div className="rounded-lg border border-[#E4E1D8] bg-white p-2.5">
                        <div className="mb-2 flex items-center gap-2 text-[10px] font-bold font-mono-code uppercase text-[#243B6B]">
                        ...
                        {isLoadingDetails ? (
                          ...
                          <div className="space-y-1.5 text-[11px] font-mono-code text-[#171A21]">
                      ...
                      <div className="rounded-lg border border-[#E4E1D8] bg-white p-2.5">
                        ...
                        {isLoadingDetails ? (
                          ...
                          <ul className="space-y-1.5 text-[11px] font-mono-code text-[#171A21]">
                            {classMethods.slice(0, 6).map((method) => (
                      ...
                      <div className="rounded-lg border border-[#E4E1D8] bg-white p-2.5">
                        ...
                        {isLoadingDetails ? (
                          ...
                          <ul className="space-y-1.5 text-[11px] font-mono-code text-[#171A21]">
                            {classFields.slice(0, 6).map((field) => (
                  ...
                  {selectedNode.data.risk === 'high' && (
                    <div className="p-2.5 bg-[#B5442C]/10 border border-[#B5442C]/30 rounded-lg flex items-start gap-2">
                      <AlertTriangle className="w-3.5 h-3.5 text-[#B5442C] shrink-0 mt-0.5" />
                      <div>
                        <h4 className="text-[10px] font-bold text-[#B5442C] uppercase font-mono-code">Regression Correlation</h4>
                        <p className="text-[10px] text-[#B5442C] mt-0.5">
